...
$query = "SELECT * FROM pedidos WHERE estado = 'pendiente' ORDER BY fecha_creacion DESC";
...
<div class="container mt-5">
    <h1 class="mb-4">Lista de pedidos pendientes</h1>
    <a href="Pedido.php" class="btn btn-primary mb-4" style="width: 200px;">Regresar</a>
                ...
                <?php if(count($pedidos) > 0): ?>
                    <?php foreach ($pedidos as $pedido): ?>
                        <tr>
                            ...
                            <td>
                                <a href="EditarPedido_procesar.php?id=<?php echo $pedido['id']; ?>" class="btn btn-sm btn-warning" style="background-color: #2952ff; border-color: #2952ff; color: white;">Editar Pedido</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
